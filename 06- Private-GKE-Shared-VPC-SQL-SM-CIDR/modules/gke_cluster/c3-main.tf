...
resource "google_container_cluster" "gke_cluster" {
  ...
  name = "${var.local_name}-private-cluster"
  ...
  workload_identity_config {
    workload_pool = "${var.gcp_project_id_2}.svc.id.goog"
  }
  ...
  master_authorized_networks_config {
    ...
    cidr_blocks {
      ...
      cidr_block   = var.subnet2_ip_cidr_range
    }

     cidr_blocks {
      display_name = "ThirdSubnet-CIDR"
      cidr_block   = var.subnet3_ip_cidr_range
    }
