...
module "shared_project" {
  ...
  project_2_sa_cs     = var.project_2_sa_cs
  project_2_sa_cs_gs  = var.project_2_sa_cs_gs
  project_2_sa_gke_gs = var.project_2_sa_gke_gs
  ...
  subnet1_id               = module.vpc.subnet1_id
  subnet2_id               = module.vpc.subnet2_id
  regional_proxy_subnet_id = module.vpc.regional_proxy_subnet_id
